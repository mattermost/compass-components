...
export const secondGroup = [
    {
        ...
        menuItems: [
            <MenuItem
                ...
                leadingElement={<Icon glyph="sort-alphabetical-ascending" />}
            />,
            <MenuItem
                label="Delete Mattermost"
                leadingElement={<Icon glyph="trash-can-outline" />}
            />,
        ],
    },
    {
        ...
        menuItems: [
            <MenuItem
                label="Sort Mattermost"
                leadingElement={<Icon glyph="folder-plus-outline" />}
            />,
