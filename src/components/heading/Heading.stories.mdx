...
<Meta component={HeadingRoot} title="Components/Heading" />
    ...
    {headingSizes.map((heading) => (
        <div key={`heading_${heading.size}`}>
            ...
            <Grid justify={'stretch'}>
                <Grid row>
                    <HeadingRoot element={'h3'} size={300}>
                ...
                <Grid row>
                    ...
                    <Grid flex={6}>
                        ...
                        <HeadingRoot element={'h1'} size={heading.size} margin={'bottom'}>
...
<ArgsTable of={HeadingRoot} exclude={['as', 'ref', 'forwardedAs', 'theme', 'className']} />

export const Template = (args) => {
    const { text } = args;
    return <HeadingRoot {...args}>{text}</HeadingRoot>;
};
