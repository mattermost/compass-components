...
const AvatarRoot = styled.button.withConfig<PAvatarRoot>({
...
})((props: ThemedStyledProps<PAvatarRoot, TTheme>): FlattenSimpleInterpolation => {
    const { theme, size, variant, disableHover, isActive } = props;
    ...
    return css`
        ...
        > div:first-child {
            ...
            ${isActive &&
            css`
                box-shadow: 0 0 0 3px ${theme.background.main},
            ...
            css`
                &:hover {
                    box-shadow: 0 0 0 ${borderSize}px ${theme.background.main},
