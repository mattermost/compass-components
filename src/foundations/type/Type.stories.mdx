    ...
    {headingSizes.map((heading) => (
        <>
            ...
            <Grid justify={'stretch'}>
                ...
                <Grid row>
                    <Grid flex={3}>
                        <Type variant={'body'} color={'secondary'} size={50} margin={'none'}>
                            Family
                        </Type>
                        <Type variant={'body'} size={200} margin={'bottom'}>
                    ...
                    <Grid flex={6}>
                        ...
                        <Type variant={'h1'} size={heading.size} margin={'bottom'}>
            ...
            <Grid justify={'stretch'}>
                ...
                <Grid row>
                    ...
                    <Grid flex={6}>
                        ...
                        <Type variant={'body'} size={body.size} margin={'bottom'}>
                            The quick brown fox jumps over the lazy dog
                        </Type>
                    </Grid>
                </Grid>
