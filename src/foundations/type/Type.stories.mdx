    ...
    {headingSizes.map((heading) => (
        <>
            ...
            <Grid justify={'stretch'}>
                <Grid row>
                    <Type element={'h3'} size={300}>{`Heading ${heading.size}${
                        heading.size === 100 ? ' (Base size)' : ''
                    }`}</Type>
                </Grid>
                <Grid row>
                    <Grid flex={3}>
                        <Type element={'body'} color={'secondary'} size={50} margin={'none'}>
                            Family
                        </Type>
                        <Type element={'body'} size={200} margin={'bottom'}>
                    ...
                    <Grid flex={6}>
                        ...
                        <Type element={'h1'} size={heading.size} margin={'bottom'}>
...
<>
    {bodySizes.map((body) => (
        <>
            ...
            <Grid justify={'stretch'}>
                <Grid row>
                    <Type element={'h3'} size={300}>{`Body ${body.size}${
                ...
                <Grid row>
                    ...
                    <Grid flex={6}>
                        ...
                        <Type element={'body'} size={body.size} margin={'bottom'}>
                            The quick brown fox jumps over the lazy dog
                        </Type>
                    </Grid>
                </Grid>
