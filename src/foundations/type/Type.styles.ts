...
const StyledType = styled.p<PStyledType>`
    .Type {
        ...
        --base-font-size: ${DEFAULT_FONT_SIZE}px;
        --base-line-height: ${DEFAULT_LINE_HEIGHT}px;
        ...
        // set body styles
        ${TYPE_SIZES.map((bodySize) =>
            generateFontSize(bodySize, BODY_FONT_SIZES, BODY_LINE_HEIGHTS)
        )}
