    ...
    {headingSizes.map((heading) => (
        <>
            ...
            <Grid justify={'stretch'}>
                ...
                <Grid row>
                    <Grid flex={3}>
                        <Typography element={'body'} color={'secondary'} size={50} margin={'none'}>
                            Family
                        </Typography>
                        <Typography element={'body'} size={200} margin={'bottom'}>
                    ...
                    <Grid flex={6}>
                        ...
                        <Typography element={'h1'} size={heading.size} margin={'bottom'}>
            ...
            <Grid justify={'stretch'}>
                ...
                <Grid row>
                    ...
                    <Grid flex={6}>
                        ...
                        <Typography element={'body'} size={body.size} margin={'bottom'}>
                            The quick brown fox jumps over the lazy dog
                        </Typography>
                    </Grid>
                </Grid>
