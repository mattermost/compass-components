...
import ThemeProvider, { DocumentationThemeProvider } from '../theme-provider/theme-provider';
            ...
            container: (props) => {
                return (
                    <DocsContainer context={props.context}>
                        <DocumentationThemeProvider>{props.children}</DocumentationThemeProvider>
                    </DocsContainer>
                );
            },
        },
