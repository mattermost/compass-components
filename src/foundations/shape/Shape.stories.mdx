...
<Grid justify={'stretch'}>
    <Grid row padding={0} alignment={'center'}>
        <Grid justify={'center'} flex={0}>
            <Shape borderRadius={0} background={'#F7F7F7'} padding={24}>
                <Shape {...defaultArgs} width={156} height={156} borderRadius={8} />
            </Shape>
            <strong>8px</strong>
        </Grid>
        <Grid justify={'center'} flex={0}>
            <Shape borderRadius={0} background={'#F7F7F7'} padding={24}>
                <Shape {...defaultArgs} width={156} height={156} borderRadius={12} />
            </Shape>
            <strong>12px</strong>
        </Grid>
        <Grid justify={'center'} flex={0}>
            <Shape borderRadius={0} background={'#F7F7F7'} padding={24}>
                <Shape {...defaultArgs} width={156} height={156} borderRadius={16} />
            </Shape>
            <strong>16px</strong>
        </Grid>
        <Grid justify={'center'} flex={0}>
            <Shape borderRadius={0} background={'#F7F7F7'} padding={24}>
                <Shape {...defaultArgs} width={156} height={156} borderRadius={20} />
            </Shape>
            <strong>20px</strong>
        </Grid>
        <Grid justify={'center'} flex={0}>
            <Shape borderRadius={0} background={'#F7F7F7'} padding={24}>
                <Shape {...defaultArgs} width={156} height={156} borderRadius={24} />
            </Shape>
            <strong>24px</strong>
        </Grid>
    </Grid>
